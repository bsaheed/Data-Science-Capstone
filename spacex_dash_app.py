...
options = [{'label':idx,'value':idx} for idx in spacex_df['Launch Site'].unique()]
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All':
        ...
        fig= px.pie(dff, values='class count', names='class', title='Total Success Launches for Site ' + entered_site)
        return fig
